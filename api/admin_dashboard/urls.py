...
from .views import (
    ...
    AdminReportCasesView,
    AdminReportCaseDetailView,
    AdminCaseAssignmentsView,
    AdminCaseAssignmentDetailView,
    AdminCaseActivityView,
    AdminSwipeStatsView,
    AdminSupportConversationListView,
    AdminSupportConversationDetailView,
    AdminSupportConversationMessagesView,
    ...
    AdminNotificationEmailTemplatesView,
    AdminNotificationEmailTemplateDetailView,
    AdminNotificationEmailLogsView,
    AdminNotificationEmailTestSendView,
    LogImpressionView,
    UpdateImpressionView,
    AdminAnalyticsImpressionsView,
    AdminAnalyticsRankingView,
...
urlpatterns = [
    ...
    path('dashboard/registration-balance/', AdminRegistrationBalanceView.as_view(), name='admin-registration-balance'),
    path('users/list/', AdminUsersListView.as_view(), name='admin-users'),
    path('users/manage/', AdminUsersManagementView.as_view(), name='admin-users-manage-create'),
    path('users/manage/<int:user_id>/', AdminUsersManagementView.as_view(), name='admin-users-manage'),
    ...
    path('reports/cases/', AdminReportCasesView.as_view(), name='admin-report-cases'),
    path('reports/cases/<int:case_id>/', AdminReportCaseDetailView.as_view(), name='admin-report-case-detail'),
    path('reports/cases/<int:case_id>/assignments/', AdminCaseAssignmentsView.as_view(), name='admin-case-assignments'),
    path('reports/cases/<int:case_id>/activity/', AdminCaseActivityView.as_view(), name='admin-case-activity'),
    path('reports/assignments/<int:assignment_id>/', AdminCaseAssignmentDetailView.as_view(), name='admin-case-assignment-detail'),
    ...
    path('support-conversations/<int:pk>/messages/', AdminSupportConversationMessagesView.as_view(), name='admin-support-conversation-messages'),
    ...
    path('notifications/email/templates/', AdminNotificationEmailTemplatesView.as_view(), name='admin-notification-email-templates'),
    path('notifications/email/templates/<int:template_id>/', AdminNotificationEmailTemplateDetailView.as_view(), name='admin-notification-email-template-detail'),
    path('notifications/email/logs/', AdminNotificationEmailLogsView.as_view(), name='admin-notification-email-logs'),
    path('notifications/email/test-send/', AdminNotificationEmailTestSendView.as_view(), name='admin-notification-email-test-send'),
