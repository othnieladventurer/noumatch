      ...
      <div className="container py-5" style={{ paddingTop: "100px", minHeight: "100vh", display: "flex", alignItems: "center" }}>
        <div className="card border-0 shadow-lg rounded-4 text-center p-4 p-md-5 mx-auto" data-aos="zoom-in" style={{ maxWidth: "500px" }}>
          ...
          <p className="text-muted mb-4">
            Votre inscription est bien enregistrée. Vous serez contactée par email dès que NouMatch sera disponible.
          </p>
          <div className="d-flex flex-column flex-sm-row gap-3 justify-content-center">
            <Link to="/" className="btn btn-danger px-4 py-2 rounded-pill">
              Retour à l'accueil
            </Link>
            <button
              onClick={() => navigate("/waitlist/men")}
