            ...
            <div>
              ...
              <div className="d-flex flex-column gap-3">
                <div className="d-flex align-items-center gap-2">
                  ...
                  <span className="fw-semibold">Découverte en avant-première de NouMatch</span>
                </div>
                <div className="d-flex align-items-center gap-2">
                  <i className="fas fa-heart text-danger"></i>
                  <span className="fw-semibold">Plus d'opportunités de connexion dès l'ouverture</span>
                </div>
                <div className="d-flex align-items-center gap-2">
                  <i className="fas fa-bolt text-danger"></i>
                  <span className="fw-semibold">Un profil visible plus tôt dans l'expérience</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="row justify-content-center g-4">
            ...
            <div className="col-lg-4 col-md-6">
              ...
              >
                ...
                <h4 className="fw-bold mb-2">Vous êtes une femme</h4>
            ...
            <div className="col-lg-4 col-md-6">
              ...
              >
                ...
                <h4 className="fw-bold mb-2">Vous êtes un homme</h4>
                <p className="text-muted mb-4">
          ...
          <div className="row g-4">
            ...
            <div className="col-md-4" data-aos="fade-up" data-aos-delay="200">
              <div className="text-center p-4">
                ...
                <p className="text-muted">Rejoindre la liste d'attente est simple, gratuit et sans engagement</p>
              </div>
            </div>
            <div className="col-md-4" data-aos="fade-up" data-aos-delay="300">
              <div className="text-center p-4">
                ...
                <p className="text-muted">Découvrez des profils en Haïti et créez des connexions plus naturelles, plus locales</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="col-lg-8">
              <div className="card border-0 shadow-sm mb-3 rounded-3 overflow-hidden">
                ...
                >
                  ...
                  {openFaq === 1 ? <FaChevronUp className="text-danger" /> : <FaChevronDown className="text-danger" />}
                </button>
                <div style={{
              ...
              <div className="card border-0 shadow-sm mb-3 rounded-3 overflow-hidden">
                ...
                >
                  ...
                  {openFaq === 2 ? <FaChevronUp className="text-danger" /> : <FaChevronDown className="text-danger" />}
                </button>
                <div style={{
              ...
              <div className="card border-0 shadow-sm rounded-3 overflow-hidden">
                ...
                >
                  ...
                  {openFaq === 3 ? <FaChevronUp className="text-danger" /> : <FaChevronDown className="text-danger" />}
                </button>
                <div style={{
